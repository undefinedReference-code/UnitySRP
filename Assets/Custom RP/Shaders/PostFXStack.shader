Shader "Hidden/Custom RP/Post FX Stack"
{
    SubShader
    {
        ...
        Pass
        {
            Name "Color Grading and Tone Mapping None"
            HLSLPROGRAM
                #pragma target 3.5
                #pragma vertex DefaultPassVertex
        ...
        Pass
        {
            Name "Color Grading and Tone Mapping ACES"
            HLSLPROGRAM
                #pragma target 3.5
                #pragma vertex DefaultPassVertex
        ...
        Pass
        {
            Name "Color Grading and Tone Mapping Neutral"
            HLSLPROGRAM
                #pragma target 3.5
                #pragma vertex DefaultPassVertex
        ...
        Pass
        {
            Name "Color Grading and Tone Mapping Reinhard"
            HLSLPROGRAM
                #pragma target 3.5
                #pragma vertex DefaultPassVertex
