...
public class Lighting
{
    ...
    public void Setup(ScriptableRenderContext context, CullingResults cullingResults, 
        bool useLightsPerObject, ShadowSettings shadowSettings, int renderingLayerMask)
    {
    ...
    void SetupDirectionalLight(int index, int visibleIndex, ref VisibleLight visibleLight, Light light)
    {
        ...
        // get the local z axis's direction in world space. 
        // -z means forward in unity.
    ...
    void SetupPointLight (int index, int visibleIndex, ref VisibleLight visibleLight, Light light) {
        ...
        // we need position instead of direction
    ...
    void SetupSpotLight (int index,  int visibleIndex, ref VisibleLight visibleLight, Light light) {
        ...
        position.w = 1f / Mathf.Max(visibleLight.range * visibleLight.range, 0.00001f);
        otherLightPositions[index] = position;
        // we need both position and direction for spot light
        Vector4 dirAndMask = -visibleLight.localToWorldMatrix.GetColumn(2);
        dirAndMask.w = light.renderingLayerMask.ReinterpretAsFloat();
        otherLightDirectionsAndMasks[index] = dirAndMask;
        ...
        // d = view \cdot light dir
        otherLightSpotAngles[index] = new Vector4(angleRangeInv, -outerCos * angleRangeInv);
        // we have got light to obtain innerSpotAngle before
        otherLightShadowData[index] = shadows.ReserveOtherShadows(light, visibleIndex);
    }
